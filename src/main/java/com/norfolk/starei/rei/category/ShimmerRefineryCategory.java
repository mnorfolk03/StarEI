...
public class ShimmerRefineryCategory implements DisplayCategory<ShimmerRefineryDisplay> {
    @Override
    public CategoryIdentifier<? extends ShimmerRefineryDisplay> getCategoryIdentifier() {
        return StarEICategories.SHIMMER_REFINERY;
    }

    @Override
    public Text getTitle() {
        return new TranslatableText("category.starei.shimmer_refinery");
    }

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(TRContent.Parts.UU_MATTER);
    }

    @Override
    public List<Widget> setupDisplay(ShimmerRefineryDisplay display, Rectangle bounds) {
